...
public class ModRecipes {
  ...
  private static Set<GrindstoneType> SKIP = Sets.newHashSet(GrindstoneType.EMPTY, GrindstoneType.STONE, GrindstoneType.GRANITE, GrindstoneType.DIORITE, GrindstoneType.ANDESITE, GrindstoneType.DIAMOND, GrindstoneType.EMERALD, GrindstoneType.OBSIDIAN);
