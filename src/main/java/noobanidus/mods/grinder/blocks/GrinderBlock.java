...
public class GrinderBlock extends AbstractFurnaceBlock {
  ...
  public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
    ...
    tooltip.add(new TranslationTextComponent("grinder.tooltip.grinder.desc").setStyle(Style.EMPTY.setColor(Color.fromTextFormatting(TextFormatting.GOLD)).setBold(true)));
  }
}
