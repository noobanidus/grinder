...
public class GrindstoneCategory implements IRecipeCategory<GrindstoneCategory.GrindstoneRecipe> {
  public static ResourceLocation UID = new ResourceLocation(Grinder.MODID, "grindstone_category");
  public static ResourceLocation BACKGROUND = new ResourceLocation(Grinder.MODID, "textures/gui/grindstone_jei.png");
